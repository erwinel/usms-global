...
declare type ScopedGlideRecord = GlideRecord | GlideRecordSecure & {
    /**
...
declare namespace $$tableFields {
    export interface IBaseRecord {
         ...
         * Maximum length: 40
         */
        sys_created_on: GlideDateTimeElement;
...
declare namespace sn_kmf_ns {
    export interface KMFCryptoModule extends Packages.com.glide.kmf.KMFCryptoModule {
    }
}