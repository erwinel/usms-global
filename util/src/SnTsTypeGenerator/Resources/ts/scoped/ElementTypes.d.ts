 ...
 * @todo: Make this a class in global
 */
export type GlideElementGeoPoint = GlideElement & Packages.com.glide.script.glide_elements.GlideElementGeoPoint;
 ...
 * @todo: Make this a class in global
 */
export type GlideElementGraphQLSchema = GlideElement & Packages.com.glide.graphql.element.GlideElementGraphQLSchema;
...
/**
 * @typedef {(GlideElement & Packages.com.glide.script.GlideElement)} GlideElementPreciseTime
 * @todo: Make this a class in global
 */
export type GlideElementPreciseTime = GlideElement & Packages.com.glide.script.GlideElement;
...
/**
 * "Variable Template Value" (?) glide element.
 * @typedef {(GlideElement & Packages.com.glide.vars2.GlideElementVariables)} GlideElementVariables
 * @todo: Make this a class in global
 */
export type GlideElementVariables = GlideElement & Packages.com.glide.vars2.GlideElementVariables;
 ...
 * @todo: Make this a class in global
 */
export type GlideElementWorkflow = GlideElement & Packages.com.glide.stages.GlideElementWorkflow;
