...
public record CustomApplication(string Name, string Value, string ID, string Version, string ShortDescription, string SysID, bool Licensable, string SubscriptionRequirement,
