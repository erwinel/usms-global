...
public record Table(string Name, string Label, string SysID, bool IsExtendable, string? NumberPrefix, Reference? Package, Reference? Scope, Reference? SuperClass,
    string AccessibleFrom, string? ExtensionModel)
{
    internal static Table? FromJson(Uri requestUri, JsonNode? jsonNode, ILogger logger, bool expectArray)
    {
        ...
        return new Table(Name: name,
            ...
            Package: Reference.FromProperty(sysDbObject, JSON_KEY_SYS_PACKAGE),
            Scope: Reference.FromProperty(sysDbObject, JSON_KEY_SYS_SCOPE),
            SuperClass: Reference.FromProperty(sysDbObject, JSON_KEY_SUPER_CLASS),
